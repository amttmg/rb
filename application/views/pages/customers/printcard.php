...
<div class="aa">
    <p><a id="print_btn" class="jqui_button">Print</a></p>
    <div id="print" class="print_area" style="width:336px; margin: 0px auto; height:100px;font-weight:400;">
        <div class="dataprint" id="dataprint" style="float:right; margin-top:100px; color:#000; margin-right:10px; letter-spacing: 2px;">
