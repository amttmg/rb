    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <button type="button" class="btn btn-primary" id="btn_add_new_productcategory"><i
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered" id="tblproductcategory">
                    <thead>
                    <tr>
                        <th>SN</th>
                        <th>Category Name</th>
                    ...
                    <?php foreach ($categories as $category): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn_edit_productcategory btn btn-xs btn-primary"
                                   data-productcategoryid="<?php echo($category->category_id) ?>"><i
